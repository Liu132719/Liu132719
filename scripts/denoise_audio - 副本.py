...
parser.add_argument("--spk", default="barbara")
...
for file in filelist:
    if file.endswith(".wav"):
        print(f'开始分离: {file} \n')
        os.system(f".\env\python.exe .\env\Scripts\demucs.exe --two-stems=vocals {raw_audio_dir}{file}")
for file in filelist:
    ...
    filename = args.spk + "_" + str(random.randint(0, 1000000))
